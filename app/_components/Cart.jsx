...
function Cart({ showCart, setShowCart }) {
  ...
  return (
    <div
      className={`cart-wrapper ${showCart ? "active" : ""} hover:cursor-pointer`}
    ...
    >
      <div className="cart-container flex flex-col">
        ...
        >
          ...
          <span className="mx-1 text-[17px] text-teal-500">
            ({cart.length} items)
          </span>
        </button>
                ...
                <div className="col-span-9 flex flex-col justify-between">
                  ...
                  <span className="mt-2">
                    <Counter
                      ...
                      handleCartItemQuantity={(newQuantity) => {
                        handleCartItemQuantity(cItem.id, newQuantity);
                      }}
                    />
                  </span>
                </div>
                ...
                <div className="col-span-3  flex flex-col justify-between items-end">
                  ...
                  <span>
                    <CircleX
                      ...
                      onClick={(e) => {
                        handleDeleteCart(e, cItem.documentId);
                      }}
                    />
                  </span>
                </div>
        ...
        <div className="mt-auto  flex justify-between mb-4 ">
          ...
          <span className="text-primary">
            ${cart.length > 0 ? +calcTotalPrice.toFixed(2) : 0}
          </span>
        </div>
        ...
        <div className="text-center my-2">
          ...
          <button
            ...
            onClick={() =>
              router.push(`/checkout?amount=${calcTotalPrice.toFixed(2)}`)
            }
          >
            pay with stripe
          </button>
